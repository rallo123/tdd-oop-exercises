...
namespace TestTools.Helpers
{
    ...
    {
        public static FieldElement Field(IExtendable instance, FieldRequirements options)
        {
        ...
        public static PropertyElement Property(IExtendable instance, PropertyRequirements options)
        {
        ...
        public static ActionMethodElement ActionMethod(IExtendable instance, MethodRequirements options)
        {
        ...
        public static FuncMethodElement FuncMethod(IExtendable instance, MethodRequirements options)
        {

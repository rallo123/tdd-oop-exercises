...
{
    public class StaticFieldDefinition<TField> : StaticFieldDefinition, IStaticAccessible<TField>, IStaticMemberable
    {
        public StaticFieldDefinition(FieldInfo fieldInfo) : base(fieldInfo)
        {
        }

        public new TField Get()
        {
            return (TField)base.Get();
        }

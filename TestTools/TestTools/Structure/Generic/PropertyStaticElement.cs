...
{
    public class PropertyStaticElement<TRoot, TProperty> : PropertyStaticElement, IStaticAccessible<TProperty>, IStaticExtendable<TRoot>
    {
        public PropertyStaticElement(PropertyInfo propertyInfo) : base(propertyInfo)
        {
        }

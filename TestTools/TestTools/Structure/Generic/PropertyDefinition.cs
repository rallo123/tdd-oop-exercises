...
{
    public class PropertyDefinition<TClass, T> : PropertyDefinition, IAccessible<TClass, T>, IMemberable<TClass>
    {
        public PropertyDefinition(PropertyInfo propertyInfo) : base(propertyInfo)
        {
        }

...
{
    public class ConstructorRequirements
    {
        public ConstructorRequirements() 
            : this(new Type[0])
        { 
        }

        public ConstructorRequirements(params Type[] types) 
            : this(types.Select(t => new ParameterOptions(t)).ToArray())
        {
        }

        public ConstructorRequirements(params ParameterOptions[] parameters)
        {
            IsPrivate = null;
            IsFamily = null;
            IsPublic = null;
